...
step3 = importlib.import_module("tml-solutions.myawesometmlsolutionml-efe0.tml_read_LOCALFILE_step_3_kafka_producetotopic_dag-myawesometmlsolutionml-efe0")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_dag-myawesometmlsolutionml-efe0",
