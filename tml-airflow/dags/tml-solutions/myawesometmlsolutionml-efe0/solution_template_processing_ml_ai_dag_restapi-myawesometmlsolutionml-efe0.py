...
step1 = importlib.import_module("tml-solutions.myawesometmlsolutionml-efe0.tml_system_step_1_getparams_dag-myawesometmlsolutionml-efe0")
step2 = importlib.import_module("tml-solutions.myawesometmlsolutionml-efe0.tml_system_step_2_kafka_createtopic_dag-myawesometmlsolutionml-efe0")
step3 = importlib.import_module("tml-solutions.myawesometmlsolutionml-efe0.tml_read_RESTAPI_step_3_kafka_producetotopic_dag-myawesometmlsolutionml-efe0")
step4 = importlib.import_module("tml-solutions.myawesometmlsolutionml-efe0.tml_system_step_4_kafka_preprocess_dag-myawesometmlsolutionml-efe0")
step5 = importlib.import_module("tml-solutions.myawesometmlsolutionml-efe0.tml_system_step_5_kafka_machine_learning_dag-myawesometmlsolutionml-efe0")
step6 = importlib.import_module("tml-solutions.myawesometmlsolutionml-efe0.tml_system_step_6_kafka_predictions_dag-myawesometmlsolutionml-efe0")
step7 = importlib.import_module("tml-solutions.myawesometmlsolutionml-efe0.tml_system_step_7_kafka_visualization_dag-myawesometmlsolutionml-efe0")
step8 = importlib.import_module("tml-solutions.myawesometmlsolutionml-efe0.tml_system_step_8_deploy_solution_to_docker_dag-myawesometmlsolutionml-efe0")
step9 = importlib.import_module("tml-solutions.myawesometmlsolutionml-efe0.tml_system_step_9_privategpt_qdrant_dag-myawesometmlsolutionml-efe0")
step10 = importlib.import_module("tml-solutions.myawesometmlsolutionml-efe0.tml_system_step_10_documentation_dag-myawesometmlsolutionml-efe0")


with DAG(
    dag_id="solution_preprocessing_ml_ai_restapi_dag-myawesometmlsolutionml-efe0",
